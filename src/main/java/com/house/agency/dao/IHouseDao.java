...
public interface IHouseDao {
	...
	List<HouseHomeData> queryHomeData(HouseHomeQueryParam param, int start, int end);

	int countManageData(HouseManageQueryParam param);

	List<HouseManageData> queryManageData(HouseManageQueryParam param, int start, int end);

	int countByCustomerRequire(HouseHomeQueryParam param);

	List<HouseHomeData> queryByCustomerRequire(HouseHomeQueryParam param, int start, int end);
}