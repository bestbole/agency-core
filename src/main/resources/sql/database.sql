...
ALTER TABLE HOUSE ADD CARD VARCHAR(50);
ALTER TABLE IMAGE ADD SORT INT;
...
ALTER TABLE TRADE_IMAGE ADD SORT INT;
ALTER TABLE TRADE_IMAGE ADD COVER CHAR(1);
ALTER TABLE TRADE ADD RELEASE_TIME DATETIME;
ALTER TABLE TRADE ADD IMAGE_ID VARCHAR(50);
ALTER TABLE TRADE ADD CONTENT CLOB;
ALTER TABLE TRADE ADD IMAGES INT;
ALTER TABLE TRADE ADD FITMENT INT;
ALTER TABLE TRADE ADD PROPERTY INT;
ALTER TABLE TRADE ADD MATCHS VARCHAR(500);
ALTER TABLE HOUSE drop column FITMENT;
ALTER TABLE HOUSE drop column OWNER;
ALTER TABLE TRADE drop column OWNER;
...
CREATE TABLE CUSTOMER_REQUIRE_NUM
(
    ID VARCHAR(50) NOT NULL,
...
alter table REGION drop column SEQ
